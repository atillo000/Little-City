...
import { CITIES, CONTRACTS, actor, attack, createSession, interact, notify, objectivePoint, recover, startContract, startReload, toggleVehicle } from '../models/worldTour/worldAdventure.js';
...
export function useWorldController() {
  ...
  return { hud, panel, ready, error, storage, host, city, current, p, point, open, action, toggleBlood, touchControl, travel, dispatchTitle, dispatchHint, task, blood, acceptContract, abandonContract, recoverToSafehouse };
}
