...
import { SPAWN, stepCar } from '../../models/neighborhood/driving.js';
import { createWorldLighting } from './lighting.js';
import { buildCity } from './cityScenery.js';
import { createCar } from '../shared/car.js';
import { createCharacter } from '../shared/character.js';
import { CHARACTER_SPAWN, LOUNGE_SPAWN, stepCharacter, nearbyStation } from '../../models/neighborhood/characterMovement.js';
import { createWeatherScene } from './weatherScene.js';
import { createCityLife } from './cityLife.js';
import { PARK, canInteract } from '../../models/neighborhood/gameLocations.js';
import { createJobScenery } from './jobScenery.js';
import { createLounge } from './loungeScenery.js';
const isInside = mode => ['office', 'lounge'].includes(mode);

export function mountNeighborhood({ host, callbacks, controlsRef, apiRef, pausedRef, lightingModeRef, gameRef, musicRef }) {
  let renderer;
