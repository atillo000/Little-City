...
import { daylightAt, DEFAULT_WEATHER_LOCATION } from '../models/environment.js';
import { fetchWeather } from '../services/weatherClient.js';
...
export function useEnvironment(mode) {
  ...
  useEffect(() => {
    ...
    async function refresh() {
      ...
      try {
        const parsed = await fetchWeather(location, { signal: request.signal });
