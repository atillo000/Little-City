...
import { advanceProgress, freshProgress, cleanProgress, missionSummary, missionValue } from './missions.js';
import { TRAFFIC_ROUTE, BIKE_ROUTE, routeLength, sampleRoute, shouldYield } from './cityLifePaths.js';
import { isDriveable } from './world.js';
import { interactionPoint, canInteract } from './gameLocations.js';
import { MISSION_LIST, currentObjective, inventory } from './missions.js';
